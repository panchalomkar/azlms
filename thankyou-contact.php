...
if(!empty($_POST)){
    ...
    //echo $user_input." captcha ".$SESSION->captcha_code;
    ...
    if (isset($SESSION->captcha_code) && $email_is_valid == 1 && strtolower($user_input) === strtolower($SESSION->captcha_code)) {
       // echo "✅ CAPTCHA correct!";
    

        // Optional: regenerate captcha code for next time
        ...
        // }
         ...
         $thank_you_message =  "Captcha does not matched.";
    }
