...
class core_renderer extends \core_renderer {
	...
	public function get_logo($context = null, $withname = false) {
    if (method_exists('core_renderer', 'get_logo')) {
        return parent::get_logo($context, $withname);
    } else {
        $logo = $this->image_url('logo', 'theme');
        return html_writer::empty_tag('img', [
            'src' => $logo,
            'alt' => get_string('logo', 'theme_boost'),
            'class' => 'logo'
        ]);
    }
}
