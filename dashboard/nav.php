...
<div class="navItemsMain" id="navMenu">
          <ul class="navItems">
            ...
            <li><a href="<?=$CFG->wwwroot?>/about.php">ABOUT US</a></li>
            <!-- <li><a href="<?=$CFG->wwwroot?>/index-start.php">GETTING STARTED</a></li> -->
            <li><a href="<?=$CFG->wwwroot?>/admission.php">ADMISSION</a></li>
            <li><a href="<?=$CFG->wwwroot?>/programs.php">PROGRAMS</a></li>
          ...
          <button class="studentCornerBtn" onClick="window.location.href='/index-start.php'">STUDENT CORNER <span>
